...
const SYSTEM_PROMPT_WITH_TOOLS = `You are a tool-calling AI assistant. Your ONLY response should be a JSON object in this EXACT format:
...
Response: {"tool": "getWeeklyHabitSummary", "arguments": {}}
